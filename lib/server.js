...
server.createPhantom = function() {
    ...
    var port = (this.options.phantomBasePort || 12300) + (this.options.worker.id % 100);
...
server.onPhantomPageCreate = function(req, res) {
    ...
    req.prerender.page.onResourceRequested(this.options.onResourceRequested || this.onResourceRequested, _.bind(_this.onResourceRequestedCallback, _this, req, res));
...
server.evaluateJavascriptOnPage = function(req, res) {
    ...
    req.prerender.page.evaluate(this.javascriptToExecuteOnPage, function(obj) {
        ...
        if(!obj.shouldWaitForPrerenderReady || (obj.shouldWaitForPrerenderReady && obj.prerenderReady)) {
            ...
            setTimeout(_.bind(_this.evaluateJavascriptOnPage, _this, req, res), (_this.options.evaluateJavascriptCheckTimeout || EVALUATE_JAVASCRIPT_CHECK_TIMEOUT));
        }
    });
};
...
server._killPhantomJS = function() {
    util.log('killing worker', this.options.worker.id, 'after', this.options.iterations, 'iterations')
